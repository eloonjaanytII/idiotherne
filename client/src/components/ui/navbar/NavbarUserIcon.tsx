  ...
  return (
    <>
      ...
      !data && 
        ...
        className={`flex items-center border-2 border-accent w-14 h-14 rounded-[50%] cursor-pointer hover:bg-accent-content ${bgTheme}`}>
    ...
    }
    {
      ...
      <div className="dropdown dropdown-hover dropdown-bottom dropdown-end">
        <div tabIndex={0} role="button" className={`flex items-end border-2 ml-2 mb-2 border-accent w-14 h-14 rounded-[50%] cursor-pointer hover:bg-accent-content ${bgTheme}`}>
