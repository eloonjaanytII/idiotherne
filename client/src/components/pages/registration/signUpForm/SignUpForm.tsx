...
interface SignUpFormProps {
  handlerSubmit: (data: SignUpFormFields) => void;
...
const SignUpForm: React.FC <SignUpFormProps> = ({handlerSubmit, registerError, step, setStep, totem, setTotem, gender, setGender}) => {
        ...
        {step === 1 && 
          <div className='flex flex-col gap-5 h-[90%]'>
              ...
              <div className='flex gap-2 justify-between'>
                ...
                {registerError && <div className='text-center'>{registerError}</div>}
